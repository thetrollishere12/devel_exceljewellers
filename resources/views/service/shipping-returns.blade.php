...
@section('page-title')
Our Shipping &amp; Return Policy - Excel Jewellers
@endsection

@section('page-description')
Excel Jewellers Shipping & Return Policy Jewellery Condition Free 30 Day Shipping Free 30 Day Return 15% Restock Fee Unworn Unaltered Good Condtion.
@endsection
...
@endsection
@section('img')
<img src="{{ asset('image/services/shipping.jpg') }}">
@endsection
@section('sub-title')
