...
<div>
  <div class="pb-2 grid grid-cols-1 md:grid-cols-2 gap-2">
	   <img class="" src="{{ asset('storage/image/page_img/guildford.jpg') }}">
    <img class="" src="{{ asset('storage/image/page_img/langley.jpg') }}">
  </div>
