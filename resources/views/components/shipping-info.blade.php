<div class="bg-zinc-100 px-2 pb-4">
    <div class="text-center text-xl py-8">SHIPPING DETAILS</div>
    <div class="m-auto text-sm" style="max-width:1000px;">
        <div class="py-2">
            <div><b>Shipping</b></div>
            <ul class="list-disc pl-8">
                <li>Free Shipping Over ${{env('FREE_SHIPPING_AMOUNT')}}</li>
